...
#pragma comment(lib, "PhysX3CharacterKinematicDEBUG_x86.lib")//Only for character controller
...
void main(int argc, char** argv) 
{
	...
	glutCreateWindow("Physics Modeling with PhysX"); // Create a window with the given title
